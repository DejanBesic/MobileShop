...
insert into Customer values('Srdjan', 'Besic', 'Zeleznicka 15', 'pwi1@gmail.com', 'pass', 0, 1, 0, 0, 2);
...
insert into Camera values ('2 MP');
insert into Camera values ('3 MP');
insert into Camera values ('4 MP');
insert into Camera values ('5 MP');
insert into Camera values ('6 MP');
insert into Camera values ('8 MP');
insert into Camera values ('10 MP');
insert into Camera values ('12 MP');
insert into Camera values ('13 MP');
insert into Camera values ('16 MP');
insert into Camera values ('20 MP');
insert into Camera values ('24 MP');
insert into Camera values ('30 MP');
insert into Camera values ('36 MP');
insert into Camera values ('44 MP');

insert into Memory values ('4 GB');
insert into Memory values ('8 GB');
insert into Memory values ('16 GB');
insert into Memory values ('32 GB');
insert into Memory values ('34 GB');
insert into Memory values ('64 GB');
insert into Memory values ('128 GB');
insert into Memory values ('256 GB');
insert into Memory values ('512 GB');
insert into Memory values ('1 TB');
insert into Memory values ('2 TB');
...
insert into RAM values ('1 GB');
insert into RAM values ('2 GB');
insert into RAM values ('3 GB');
insert into RAM values ('4 GB');
insert into RAM values ('6 GB');
